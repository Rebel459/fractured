...
public final class FracturedLootTables {
    ...
    public static void init() {
        LootTableEvents.MODIFY.register((id, tableBuilder, source, registries) -> {
            ...
            if (BuiltInLootTables.STRONGHOLD_CORRIDOR.equals(id) && FracturedConfig.stronghold_eye_chance > 0) {
            ...
            if (BuiltInLootTables.STRONGHOLD_CROSSING.equals(id) && FracturedConfig.stronghold_eye_chance > 0) {
                pool = LootPool.lootPool().setRolls(ConstantValue.exactly(1.0F))
                        .add(EmptyLootItem.emptyItem().setWeight(100-FracturedConfig.stronghold_eye_chance))
                        .add(LootItem.lootTableItem(FracturedItems.FRACTURED_EYE).setWeight(FracturedConfig.stronghold_eye_chance)
                        );tableBuilder.withPool(pool);
            }
            if (BuiltInLootTables.ABANDONED_MINESHAFT.equals(id) && FracturedConfig.abandoned_mineshaft_eye_chance > 0) {
                pool = LootPool.lootPool().setRolls(ConstantValue.exactly(1.0F))
            ...
            if (BuiltInLootTables.DESERT_PYRAMID.equals(id) && FracturedConfig.desert_pyramid_eye_chance > 0) {
                pool = LootPool.lootPool().setRolls(ConstantValue.exactly(1.0F))
            ...
            if (BuiltInLootTables.JUNGLE_TEMPLE.equals(id) && FracturedConfig.jungle_temple_eye_chance > 0) {
                pool = LootPool.lootPool().setRolls(ConstantValue.exactly(1.0F))
            ...
            if (BuiltInLootTables.NETHER_BRIDGE.equals(id) && FracturedConfig.nether_fortress_eye_chance > 0) {
                pool = LootPool.lootPool().setRolls(ConstantValue.exactly(1.0F))
            ...
            if (BuiltInLootTables.SHIPWRECK_TREASURE.equals(id) && FracturedConfig.shipwreck_eye_chance > 0) {
                pool = LootPool.lootPool().setRolls(ConstantValue.exactly(1.0F))
            ...
            if (BuiltInLootTables.IGLOO_CHEST.equals(id) && FracturedConfig.igloo_eye_chance > 0) {
                pool = LootPool.lootPool().setRolls(ConstantValue.exactly(1.0F))
            ...
            if (BuiltInLootTables.SIMPLE_DUNGEON.equals(id) && FracturedConfig.dungeon_eye_chance > 0) {
                pool = LootPool.lootPool().setRolls(ConstantValue.exactly(1.0F))
            ...
            if (BuiltInLootTables.WOODLAND_MANSION.equals(id) && FracturedConfig.woodland_mansion_eye_chance > 0) {
                pool = LootPool.lootPool().setRolls(ConstantValue.exactly(1.0F))
            ...
            if (BuiltInLootTables.PILLAGER_OUTPOST.equals(id) && FracturedConfig.pillager_outpost_eye_chance > 0) {
                pool = LootPool.lootPool().setRolls(ConstantValue.exactly(1.0F))
            ...
            if (BuiltInLootTables.BASTION_BRIDGE.equals(id) && FracturedConfig.bastion_remnant_eye_chance > 0) {
                pool = LootPool.lootPool().setRolls(ConstantValue.exactly(1.0F))
            ...
            if (BuiltInLootTables.BASTION_OTHER.equals(id) && FracturedConfig.bastion_remnant_eye_chance > 0) {
                pool = LootPool.lootPool().setRolls(ConstantValue.exactly(1.0F))
                        .add(EmptyLootItem.emptyItem().setWeight(100-FracturedConfig.bastion_remnant_eye_chance))
                        .add(LootItem.lootTableItem(FracturedItems.FRACTURED_EYE).setWeight(FracturedConfig.bastion_remnant_eye_chance)
                        );tableBuilder.withPool(pool);
            }
            if (BuiltInLootTables.UNDERWATER_RUIN_BIG.equals(id) && FracturedConfig.ocean_ruins_eye_chance > 0) {
                pool = LootPool.lootPool().setRolls(ConstantValue.exactly(1.0F))
            ...
            if (BuiltInLootTables.UNDERWATER_RUIN_SMALL.equals(id) && FracturedConfig.ocean_ruins_eye_chance > 0) {
                pool = LootPool.lootPool().setRolls(ConstantValue.exactly(1.0F))
                        .add(EmptyLootItem.emptyItem().setWeight(100-FracturedConfig.ocean_ruins_eye_chance))
                        .add(LootItem.lootTableItem(FracturedItems.FRACTURED_EYE).setWeight(FracturedConfig.ocean_ruins_eye_chance)
                        );tableBuilder.withPool(pool);
            }
            if (BuiltInLootTables.RUINED_PORTAL.equals(id) && FracturedConfig.ruined_portal_eye_chance > 0) {
                pool = LootPool.lootPool().setRolls(ConstantValue.exactly(1.0F))
            ...
            if (BuiltInLootTables.ANCIENT_CITY.equals(id) && FracturedConfig.ancient_city_eye_chance > 0) {
                pool = LootPool.lootPool().setRolls(ConstantValue.exactly(1.0F))
            ...
            if (BuiltInLootTables.BURIED_TREASURE.equals(id) && FracturedConfig.buried_treasure_eye_chance > 0) {
                pool = LootPool.lootPool().setRolls(ConstantValue.exactly(1.0F))
